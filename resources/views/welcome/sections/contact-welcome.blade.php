      ...
      <div class="text-white lg:w-1/2 lg:mx-6">
        ...
        <div class="mt-8 sm:mt-14 text-center sm:text-left sm:ml-0 lg:ml-20">
          ...
          <div class="flex justify-center sm:justify-start space-x-6">
            <a class="text-white transition-colors duration-300 transform hover:text-ungu-dark" href="#">
          ...
          <form class="mt-6">
            <div class="flex-1">
              ...
              <input type="text" placeholder="John Doe"
                class="block w-full px-4 sm:px-5 py-2.5 sm:py-3 mt-2 text-gray-700 bg-white border border-black rounded-md focus:border-ungu-dark focus:ring-ungu-dark focus:ring-opacity-40 focus:outline-none focus:ring" />
            </div>
            ...
            <div class="w-full mt-6">
              <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Pertanyaan</label>
              <textarea

...
<div x-data="{ open: false }" x-show="open"
  x-on:profile-success.window="open = true; setTimeout(() => open = false, 3000)"
...
{{-- Modal Error Start --}}
<div x-data="{ open: false }" x-show="open" @profile-error.window="open = true"
  @close-profile-error.window="open = false" x-transition:enter="transition ease-out duration-300"

<aside
  ...
  <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
    <ul class="space-y-2">
      <li>
        <x-sidebar-link href="{{ route('dashboard-admin') }}" wire:navigate :active="request()->is('admin/dashboard')">
      ...
      <li x-data="{ open: false }">
        <x-sidebar-button-link>
          <x-slot name="trigger">
            ...
            <i class="fa-solid fa-angle-down transition-transform duration-200" :class="{'rotate-180': open}"></i>
          </x-slot>
    ...
    <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
      <li>
        <x-sidebar-link href="#" :active="request()->is('gallery/all')">

<div>
    <aside
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            <ul class="space-y-2">
                <li>
                    <x-sidebar-link href="{{ route('dashboard-admin') }}" wire:navigate
                        :active="request()->is('admin/dashboard')">
                        <i class="fa-solid fa-house transition duration-75"></i>
                ...
                <li x-data="{ open: false }">
                    <x-sidebar-button-link>
                        <x-slot name="trigger">
                            <i class="fa-solid fa-list transition duration-75"></i>
                        ...
                        <x-slot name="content">
                            <x-sidebar-dropdown-link href="{{ route('category-product') }}" wire:navigate>
                                Product
                            </x-sidebar-dropdown-link>

                            <x-sidebar-dropdown-link href="#">Gallery</x-sidebar-dropdown-link>

                            <x-sidebar-dropdown-link href="#">fafdafa</x-sidebar-dropdown-link>
                        </x-slot>
                    </x-sidebar-button-link>
                </li>
                ...
                <li x-data="{ open: false }">
                    <x-sidebar-button-link>
                        <x-slot name="trigger">
                            <i class="fa-solid fa-bag-shopping transition duration-75"></i>
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <x-sidebar-link href="{{ route('list-question') }}" wire:navigate
                        :active="request()->is('admin/question/list-question')">
                        <i class="fa-solid fa-circle-question flex-shrink-0 text-2xl transition duration-75"></i>

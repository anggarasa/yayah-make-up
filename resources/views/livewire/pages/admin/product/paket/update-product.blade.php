                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    <i class="fa-solid fa-angle-right shrink-0 mx-2 size-4 text-gray-400"></i>
                                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Update-Product</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
            ...
            <div class="max-w-3xl mx-auto py-12 px-4 bg-white rounded-lg border border-black">
                ...
                <form wire:submit="updateProduct">
                    ...
                    <div class="mt-8" x-data="{ imagePreview: null }">
                        ...
                        <div class="flex items-center gap-5">
                            <div x-show="imagePreview" class="mt-6">
                                @if ($productId)
                                <h3 class="font-semibold">Cover Image Baru:</h3>
                                @endif
                        ...
                        <div class="flex items-center gap-5">
                            <div class="mt-6">
                                <h3 class="font-semibold">Cover Image Lama:</h3>
                                <img src="{{ asset('storage/'. $coverLama) }}" alt="Cover Image"
                    ...
                    <div class="mt-8" x-data="imagePreview()">
                        ...
                        @if ($productId)
                        <h3 class="font-semibold">Gambar Baru :</h3>
                        @endif
                        ...
                        @if ($productId)
                        <h3 class="font-semibold">Gambar Lama :</h3>
                        <div class="grid grid-cols-3 gap-4">
                            @foreach ($imageLama->where('media_type', 'Image') as $image)
                            <div class="border rounded overflow-hidden">
                                <img src="{{ asset('storage/'. $image->file_path) }}" class="w-full h-32 object-cover">
                            </div>
                            @endforeach
                        </div>
                        @endif
                    ...
                    <div class="mt-8" x-data="videoPreview()">
                        ...
                        @if ($productId)
                        <h3 class="font-semibold">Video Baru :</h3>
                        @endif
                        <div class="grid grid-cols-3 gap-4">
                        ...
                        @if ($productId)
                        <h3 class="font-semibold">Video Lama :</h3>
                        <div class="grid grid-cols-3 gap-4">
                            @foreach ($videoLama->where('media_type', 'Video') as $video)
                            <div class="border rounded overflow-hidden">
                                <video controls class="w-full h-32 object-cover">

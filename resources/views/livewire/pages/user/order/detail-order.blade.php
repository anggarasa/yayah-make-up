<div class="min-h-screen" x-data="{ showModal: false }">
    ...
    <div class="container mx-auto px-4 py-8 md:mt-10 lg:pb-12 lg:mt-0">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center space-x-3 p-4 bg-red-100 text-red-700 rounded-lg">
                        ...
                        <div>
                            <p class="font-semibold">Pesanan Anda Telah Dibatalkan</p>
                            <p class="text-sm">Kami telah membatalkan pesanan Anda. Anda dapat melihat
                                detail lebih lanjut di riwayat pesanan.</p>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <div wire:loading.flex class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            ...
            <div class="fixed bottom-0 left-0 right-0 bg-white p-4 shadow-lg lg:relative lg:shadow-none lg:p-0">
                <div class="flex space-x-2">
                    ...
                    @elseif ($order->status_payment === 'settlement')
                    <button type="button" @click="$dispatch('modal-confirm-order')"
    ...
    {{-- Modal notification --}}
    @include('user.modals.modal-payment-notifikasi')
    {{-- Modal notification --}}

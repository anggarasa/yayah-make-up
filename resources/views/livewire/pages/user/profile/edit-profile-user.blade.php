<div class="flex-1 p-8" x-data="{ previewImage: null }">
                ...
                <div class="flex items-center space-x-6">
                    <div class="shrink-0">
                        ...
                        <img class="h-32 w-32 object-cover rounded-full"
                            :src="previewImage || '{{ asset('storage/uploads/profile') }}/{{ $user->profile }}'"
                            alt="Profile picture">
    ...
    <!-- Modal -->
    @include('user.modals.modal-profile-notifikasi')

    <script>
        document.addEventListener('redirectAfterDelay', event => {
            setTimeout(() => {
